...
test('calcStepDiff() - throws error if numbers not provided', () => {
  const error = 'calcStepDiff in UtilGanttScale must have numbers in all these parameters [lastStep, firstStep]'
...
test('calcScalePerc() - throws error if numbers not provided', () => {
  const error = 'calcScalePerc in UtilGanttScale must have numbers in all these parameters [step, stepDiff]'
